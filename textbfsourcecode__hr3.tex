\textbf{sourcecode} : \href{https://github.com/miura/BIAS_Nucleus_Segmentation/blob/struct_authorea/code_redirectedMeasurement.ijm}{code/code\_redirectedMeasurement.ijm}
