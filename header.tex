...
\lhead{\fancyplain{}{\textit{EMBL BIAS 2016} }}
\chead{}
...
\newcommand{\ijmenu}[1][]{\textit{\small#1}}
\newcommand{\ilcom}[1][]{\pbox[c]{\textwidth}{#1}}
...
{\bfseries NEUBIAS Textbook Series}\\[\baselineskip]
{\textcolor{Medium}{\big Intensity Dynamics at the Periphery of Nucleus }}\\[\baselineskip]
{\small  Continuous release}\par
\vfill
